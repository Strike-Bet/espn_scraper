...
# }
    ...
    response = requests.post(f"{os.getenv('BACKEND_URL')}/api/betting-events/bulk", headers=headers, json=sample_betting_events_nba)
    print(response.text)
    ...
    response = requests.post(f"{os.getenv('BACKEND_URL')}/api/betting-events/bulk", headers=headers, json=sample_betting_events_nfl)
