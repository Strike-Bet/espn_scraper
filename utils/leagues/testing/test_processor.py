...
#     response = requests.post("http://localhost:8080/api/betting-events/bulk", headers=headers, json=sample_betting_events_nba)
...
#         print("No NBA games found for testing")
    ...
    response = requests.post("http://localhost:8080/api/betting-events/bulk", headers=headers, json=sample_betting_events_nfl)
